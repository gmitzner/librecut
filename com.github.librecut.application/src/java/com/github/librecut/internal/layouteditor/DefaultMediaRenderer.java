...
public class DefaultMediaRenderer implements IMediaRenderer {
	...
	private void drawMedia(GC gc, Rectangle mediaArea) {
		...
		gc.setBackground(color);
		gc.fillRectangle(mediaArea.x + mediaArea.width, mediaArea.y + 2, 2, mediaArea.height);
		gc.fillRectangle(mediaArea.x + 2, mediaArea.y + mediaArea.height, mediaArea.width, 2);
	}
